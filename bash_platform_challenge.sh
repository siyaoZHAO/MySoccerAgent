...
conda activate sn
cd /home/zhaosiyao/SoccerAgent
export OPENROUTER_API_KEY=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
export OPENAI_API_KEY=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
export OPENAI_BASE_URL=https://openrouter.ai/api/v1
python platform_full_version.py \
    --input_file /data/zhaosiyao/SoccerNet/SoccerNet-SN-VQA-2026/challenge/challenge.json \
    --output_file metadata_ma_challenge_$(date +%Y%m%d_%H%M%S).json \
